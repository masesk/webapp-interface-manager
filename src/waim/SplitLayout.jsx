...
import { layoutSizeChange } from '../redux/actions'
...
const SplitLayout = ({ windows, layoutType, indexPath, layoutSizeChange }) => {
...
export default connect(mapStateToProps, { layoutSizeChange })(SplitLayout);